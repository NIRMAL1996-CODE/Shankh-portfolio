...
const AboutPage = () => {
  return (
    <section
      ...
      <div className="bg-white/20 w-full max-w-[800px] h-[400px] backdrop-blur-s rounded-3xl p-16 shadow-xl transform hover:-translate-y-2 hover:scale-105 transition-all">
        {/* Heading */}
        ...
        {/* Subtitle */}
        <p className="text-lg sm:text-xl text-[#540863]">
          Music Producer • Educator • Performer
        </p>

        {/* Paragraph */}
        <p className="text-[#540863] text-base sm:text-lg mt-6 leading-relaxed">
        ...
        <p className="text-[#540863] text-base sm:text-lg mt-4 leading-relaxed">
